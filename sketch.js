...
function draw(){
  ...
  if (gamestate === SERVE){
    ...
    textSize(30)
    fill("black")
    text ("Try to pass the red ball over the white bubble" , 40,120)
    text ("as much as you can to make it bigger in size. ",40,160)

    text ("Try not to touch the black bar or else the",40,210)
